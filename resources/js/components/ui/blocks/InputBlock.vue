  ...
  <div class="flex flex-col gap-1">
    ...
    <div class="flex flex-col gap-1">
      ...
      <div class="phone-wrapper" v-if="name === 'phone' && type !== 'checkbox'">
        ...
        />
        <span class="text-[12px] text-[#99A1AF]" v-if="subtitle">{{
          subtitle
        }}</span>
      </div>
      ...
      <div v-else-if="name === 'description' && type !== 'checkbox'">
        <textarea
          :name="name"
          v-model="value"
          class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
          >{{ value }}</textarea
        >
        <span class="text-[12px] text-[#99A1AF]" v-if="subtitle">{{
          subtitle
