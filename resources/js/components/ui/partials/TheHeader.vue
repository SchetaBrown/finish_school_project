...
<template>
  <header
    class="flex items-center justify-center bg-white h-20 w-full border-b border-gray-200 mb-20"
  >
    <div
      class="flex items-center justify-between max-w-360 w-full mx-auto px-4 sm:px-6 lg:px-8"
    >
      <Logotype></Logotype>
      <div class="flex items-center" v-if="IS_AUTH"></div>
